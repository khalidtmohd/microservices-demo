...
syft packages mohdkhalid/adservice:86511cf --scope all-layers -o json  > adservice.json

syft packages mohdkhalid/currencyservice:86511cf --scope all-layers -o json  > currencyservice.json
syft packages mohdkhalid/shippingservice:86511cf --scope all-layers -o json  > shippingservice.json
syft packages mohdkhalid/frontend:86511cf --scope all-layers -o json  > frontend.json
syft packages mohdkhalid/paymentservice:86511cf --scope all-layers -o json  > paymentservice.json
syft packages mohdkhalid/cartservice:86511cf --scope all-layers -o json  > cartservice.json
syft packages mohdkhalid/recommendationservice:86511cf --scope all-layers -o json  > recommendationservice.json
syft packages mohdkhalid/productcatalogservice:86511cf --scope all-layers -o json  > productcatalogservice.json
syft packages mohdkhalid/emailservice:86511cf:86511cf --scope all-layers -o json  > emailservice.json
syft packages mohdkhalid/checkoutservice:86511cf --scope all-layers -o json  > checkoutservice.json
syft packages mohdkhalid/loadgenerator:86511cf --scope all-layers -o json  > loadgenerator.json
